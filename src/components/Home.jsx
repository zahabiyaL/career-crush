  ...
  return (
    <section className="realtive">
      <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        ...
        <h1 className="text-cc-dblue font-glook text-3xl md:text-4 lg:text-5xl text-center mb-8"><span className="font-light text-[15px] md:text-md lg:text-[30px]">Welcome to<br /></span>Career Crush
        </h1>
        ...
        <p className="text-white/60 font-glook text-ld md:text-3xl mt-[200px] lg:mt-[120px] md:tracking-wider">You don&apos;t need love, you need a job!</p>
      </div>
    </div>
    </section>
